    ...
    return {
        ...
        "agents": [
            ...
            },
            {
                ...
                "model": "gpt-5-nano",
                "focus_areas": ["Brevity", "Impact focus", "Executive communication", "Key highlights"]
            },
            {
                ...
                "model": "gpt-5",
                "reasoning": {"effort": "high"},
                "focus_areas": ["Overall optimization", "Comprehensive improvement", "Professional enhancement", "Quality maximization"]
            },
            {
                ...
                "focus_areas": ["General improvement", "Balanced optimization", "Content enhancement", "Professional polish"]
            },
            {
                ...
                "model": "o4-mini",
                "reasoning": {"effort": "medium"},
                "focus_areas": ["Efficient optimization", "Multi-area improvement", "Quick enhancement", "Streamlined polish"]
            }
        ],
        "judge": {
            "model": "gpt-5",
...
def main():
    ...
    parser.add_argument(
        "--review",
        type=str,
        help="Performance review text (overrides config)"
    )
    parser.add_argument(
        "--rubric",
        type=str,
        help="Career ladder/rubric text (overrides config)"
    )
    parser.add_argument(
        "--output",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Number of optimizer agents"
    )
    parser.add_argument(
        "--rounds",
        type=int,
    ...
    try:
        ...
        original_submission = Submission(
            id="original",
            content=config["original_review"],
            agent_name=None
        )
