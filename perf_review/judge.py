...
class LLMJudge:
    ...
    def __init__(self, openai_client: OpenAIClient, model: str = "gpt-4.1", judge_id: Optional[str] = None, reasoning: Optional[Dict[str, Any]] = None):
        """
...
Use the judge_comparison function to provide your structured judgment."""
    ...
    def _create_comparison_prompt(self, submission_a: Submission, submission_b: Submission) -> str:
    ...
    def batch_compare(
        ...
        for i in range(len(submissions)):
            for j in range(i + 1, len(submissions)):
                ...
                match = self.compare_submissions(
                    submissions[i],
                    submissions[j],
                    rubric
                )
